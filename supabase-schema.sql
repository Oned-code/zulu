...
CREATE TABLE IF NOT EXISTS public.businesses (
  ...
  description TEXT,
  niche TEXT CHECK (niche IN ('power', 'security', 'real_estate', 'automotive', 'education')),
  phone TEXT,
  email TEXT,
  website TEXT,
  address TEXT,
...
CREATE TABLE IF NOT EXISTS public.quotes (
  ...
  niche TEXT NOT NULL CHECK (niche IN ('power', 'security', 'real_estate', 'automotive', 'education')),
  title TEXT NOT NULL,
  description TEXT,
  requirements TEXT,
  location TEXT,
...
CREATE TABLE IF NOT EXISTS public.articles (
  ...
  excerpt TEXT,
  content TEXT,
  category TEXT CHECK (category IN ('ai', 'energy', 'security', 'property', 'automotive', 'education', 'business', 'technology')),
  author TEXT,
  featured_image TEXT,
  tags TEXT[],
  read_time INTEGER,
