    ...
    return (
      <div className="bg-white p-8 rounded-2xl shadow-xl text-center border border-green-100">
        ...
        <p className="text-zinc-600 mb-6">
          Your request has been submitted. Up to 4 professionals will contact you shortly.
        </p>
        <Button onClick={() => window.location.href = '/'} className="w-full bg-zulu-indigo text-zulu-gold hover:bg-zulu-indigo/90">
          Return to Homepage
        </Button>
      </div>
    );
        ...
        {step === 2 && (
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input id="location" required placeholder="Sandton, Johannesburg" />
            </div>
            
            <div className="flex items-start space-x-3 mt-4 mb-6">
              <input type="checkbox" id="terms" required className="mt-1 h-4 w-4 rounded border-zinc-300 text-zulu-gold focus:ring-zulu-gold" />
